...
==============================================================================
Scripts Purpose:
   This sript creates a new database named 'DataWareHouse' after checking if it already exists;
...
Warning:
   ...
   All data in the database will be permanentaly deleted. Proceed with caution
